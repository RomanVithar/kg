...
import vsu.cg.tasks.engine.base_figures.arch.Arch;
import vsu.cg.tasks.engine.base_figures.arch.arch_extends.ArchBresenham;
import vsu.cg.tasks.engine.base_figures.circle.Circle;
import vsu.cg.tasks.engine.base_figures.circle.circle_extends.CircleBresenham;
import vsu.cg.tasks.engine.base_figures.circle.circle_extends.CirclePie;
import vsu.cg.tasks.engine.base_figures.ellipse.Ellipse;
import vsu.cg.tasks.engine.base_figures.ellipse.ellipse_extends.EllipseBresenham;
import vsu.cg.tasks.engine.base_figures.ellipse.ellipse_extends.FillEllipse;
import vsu.cg.tasks.engine.base_figures.line.Line;
import vsu.cg.tasks.engine.base_figures.line.line_extends.LineWu;
